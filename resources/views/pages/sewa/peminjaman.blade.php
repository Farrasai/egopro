                    ...
                    @if($row->status_peminjaman == 1 || $row->status_peminjaman == 2)
                        ...
                        <td>
                          ...
                          @elseif($row->pembayaran == 1)
                            <div class="badge progress-bar-success mt-3" style="margin-left: 20px">Bayar DP</div>
                          @elseif($row->pembayaran == 2)
                            <div class="badge progress-bar-success mt-3" style="margin-left: 16px">Bayar Ditempat</div>
                          @endif
                        </td>
                        <td scope="col">
